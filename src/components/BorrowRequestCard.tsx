...
import { BorrowRequest } from "./BorrowRequestTable";

interface BorrowRequestCardProps {
  request: BorrowRequest;
}

const BorrowRequestCard = ({ request }: BorrowRequestCardProps) => {
      ...
      <CardContent className="flex flex-col space-y-3">
        <div className="flex items-center justify-between">
          <Typography variant="h6" color="textPrimary">
            Mã phiếu mượn thiết bị: {request.id}
          </Typography>
        </div>
        ...
        <Typography variant="body1" color="textSecondary">
          <span className="font-semibold">ID thiết bị:</span> {request.equipment.equipmentId}
          <span className="font-semibold ml-4">Tên thiết bị:</span> {request.equipment.equipmentName}
        </Typography>
        ...
        <Typography variant="body1" color="textSecondary">
          <span className="font-semibold">Số lượng mượn:</span> {request.quantity}
        </Typography>
